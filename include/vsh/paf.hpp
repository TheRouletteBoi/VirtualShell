...
void paf_0C74837D(Surface const* _this, void* pool, int width, int height, int imageMode, int imageOrder, bool r9, int r10); // paf::Surface::Surface(paf::SurfacePool *, int, int, ImageMode, ImageOrder, bool, int, int)
...
void* paf_34EBB81E(void* _this, int r4, int r5); // _ZN3paf11SurfacePool8AllocateEii										// paf::SurfacePool::Allocate(int, int)
...
void paf_63D446B8(PhWidget const* widget, unsigned int r4, bool r5); // paf::PhWidget::DrawThis(unsigned int, bool)
...
public:
    ...
    inline R CallMethod(int index, Args... args)
    {
        opd_t** opd = reinterpret_cast<opd_t**>(this);
...
public:
    Framework(InitParam const& initParam)
    {
        paf_A5B4FB55(this, (void*)&initParam);
    }
    ...
    int RequestShutdown()
    {
        return paf_1565FC46(this);
    }

    int Begin(float frameTime)
    {
        return paf_59BDA198(this, frameTime);
    }

    int Run(float frameTime)
    {
        return paf_85D1D23B(this, frameTime);
    }

    int End(float frameTime)
    {
        return paf_0EAA28B8(this, frameTime);
    }
...
{
public:
    void* Allocate(int boundary, int size)
    {
        if (!SurfaceHeap)
            return nullptr;
        ...
        void* addr = SurfaceHeap->vtable->CallMethod<void*>(2, SurfaceHeap, boundary, size);

        if (addr)
            surfaceCount++;

        int currentSize = maxSize - GetFreeSize();
        if (currentSize > sizeUsed)
    ...
    void Free(void* ptr)
    {
        ...
        SurfaceHeap->vtable->CallMethod<void>(3, SurfaceHeap, ptr);
        surfaceCount--;
    }
    ...
    int GetFreeSize()
    {
        ...
        return SurfaceHeap->vtable->CallMethod<int>(4, SurfaceHeap);
    }
...
public:
    ...
    Surface(void* pool, int width, int height, int imageMode, int imageOrder, bool a7, int a8)
    {
        vsh::memset(this, 0, sizeof(Surface));
        paf_0C74837D(this, pool, width, height, imageMode, imageOrder, a7, a8);
    }

    void* operator new(size_t size)
    {
        return vsh::sce_paf_private_malloc(size);
    }
...
public:
    ...
    bool a7;
    int unk1; // = 2
    short widthFloorLog2;
    short heightFloorLog2;
    float widthDiv; // (float)width / (float)widthFloorLog2
    float heightDiv; // (float)height / (float)heightFloorLog2
    int unk2;
    int unk3;
    short unk4;
    short a9;
    ...
    int unk7;
    short boundary_0;
    int unk8; // 3 - imageOrder * unk2
    Surface* surfacePtr;
    Surface* surfaceClutPtr;
    SurfacePool* pool;
};
...
public:
    ...
    std::string name;
    std::string main;
    char __padding_0x3C[0x11C];
    SurfacePool* surfacePool; // 0x158
    // ...
};
...
{
public:
    Module(const char* path, sys_memory_container_t* memContainer = nullptr)
    {
        paf_CF068D31(this, path, 0, 0, memContainer);
    }
    ...
    void SetInterface(int interfaceId, void* interfaceStruct)
    {
        paf_3F7CB0BF(this, interfaceId, interfaceStruct);
    }
...
public:
    ...
    inline T VirtualMethod(int index, Args... args)
    {
        return vtable->CallMethod<T>(index, this, args...);
    }

    // vtable
    ~PhAppear(){ VirtualMethod(0); }
    void Destructor2(){ VirtualMethod(1); }
    void SetOwner(paf::PhWidget const* owner){ VirtualMethod(2, owner); }
    void SetStyle_ontimer(int style, bool value){ VirtualMethod(3, style, value); }
    void SetStyle_ontimer(int style, int value){ VirtualMethod(4, style, value); }
    void SetStyle_ontimer(int style, float value){ VirtualMethod(5, style, value); }
    void SetStyle_ontimer(int style, vec4 const& value){ VirtualMethod(6, style, value); }
    void SetStyle_ontimer(int style, int r5, bool value){ VirtualMethod(7, style, r5, value); }
    void SetStyle_ontimer(int style, int r5, int value){ VirtualMethod(8, style, r5, value); }
    void SetStyle_ontimer(int style, int r5, float value){ VirtualMethod(9, style, r5, value); }
    void SetStyle_ontimer(int style, int r5, vec4 const& value){ VirtualMethod(10, style, r5, value); }
    int SetStyle(int style, bool value){ return VirtualMethod(11, style, value); }
    int SetStyle(int style, int value){ return VirtualMethod(12, style, value); }
    int SetStyle(int style, float value){ return VirtualMethod(13, style, value); }
    int SetStyle(int style, vec4 const& value){ return VirtualMethod(14, style, &value); }
    int SetStyle(int style, int r5, bool value){ return VirtualMethod(15, style, r5, value); }
    int SetStyle(int style, int r5, int value){ return VirtualMethod(16, style, r5, value); }
    int SetStyle(int style, int r5, float value){ return VirtualMethod(17, style, r5, value); }
    int SetStyle(int style, int r5, vec4 const& value){ return VirtualMethod(18, style, r5, &value); }
    int GetStyle(int style, bool& value){ return VirtualMethod(19, style, &value); }
    int GetStyle(int style, int& value){ return VirtualMethod(20, style, &value); }
    int GetStyle(int style, float& value){ return VirtualMethod(21, style, &value); }
    int GetStyle(int style, vec4& value){ return VirtualMethod(22, style, &value); }
    int GetStyle(int style, mat4& value){ return VirtualMethod(23, style, &value); }
    int GetStyle(int style, int r5, bool& value){ return VirtualMethod(24, style, r5, &value); }
    int GetStyle(int style, int r5, int& value){ return VirtualMethod(25, style, r5, &value); }
    int GetStyle(int style, int r5, float& value){ return VirtualMethod(26, style, r5, &value); }
    int GetStyle(int style, int r5, vec4& value){ return VirtualMethod(27, style, r5, &value); }
    int GetStyle(int style, int r5, mat4& value){ return VirtualMethod(28, style, r5, &value); }
    int SetLayoutStyle(int style, int r5, float value){ return VirtualMethod(29, style, r5, value); }
    int SetLayoutStyle(int style, int r5, int r6, int r7, vec4 value){ return VirtualMethod(30, style, r5, r6, r7, value); }
    int SetLayoutStyle(int style, int r5, int r6, float value){ return VirtualMethod(31, style, r5, r6, value); }
    int SetLayoutStyle(int style, int r5, int r6, int r7, int r8, vec4 value){ return VirtualMethod(32, style, r5, r6, r7, r8, value); }
    int GetLayoutStyle(int style, int & r5, float & value){ return VirtualMethod(33, style, &r5, &value); }
    int GetLayoutStyle(int style, int & r5, int & r6, int & r7, vec4 & value){ return VirtualMethod(34, style, &r5, &r6, &value); }
    int GetLayoutStyle(int style, int r5, int & r6, float & value){ return VirtualMethod(35, style, r5, &r6, &value); }
    int GetLayoutStyle(int style, int r5, int & r6, int & r7, int & r8, vec4 & value){ return VirtualMethod(36, style, r5, &r6, &r7, &r8, &value); }
    void UpdateLayoutStyle(int style){ VirtualMethod(37, style); }
    void Unknown(){ VirtualMethod(38); }
    int SetSize(vec4 const& size){ return VirtualMethod(39, &size); }
    int SetTexture(paf::SurfaceRCPtr<paf::Surface> const& r4, int r5){ return VirtualMethod(40, &r4, r5); }
    int GetTexture(paf::SurfaceRCPtr<paf::Surface> &r4, int r5){ return VirtualMethod(41, &r4, r5); }
    int SetText(std::wstring const& r4, int r5){ return VirtualMethod(42, &r4, r5); }
    int GetText(std::wstring &r4, int r5){ return VirtualMethod(43, &r4, r5); }
    int GetSText(PhSText** stext, int unused = 0){ return VirtualMethod(44, stext, unused); }
    int GetAnimParam(int r4, void *r5){ return VirtualMethod(45, r4, r5); }
    int SetAppearAnim(int r4, float f1, float f2, int r7, vec4 const& r8, void(*r9)(PhWidget*, void*, int, void *)){ return VirtualMethod(46, r4, f1, f2, r7, r8, r9); }
    bool IsReady(){ return VirtualMethod<bool>(47); }
    void RenderState(unsigned int r4, bool r5){ VirtualMethod(48, r4, r5); }
...
public:
    ...
    int DoCallBack(int callbackId, PhEvent* phEvent)
    {
    ...
    {
        return paf_986427A7(this, callbackId, callback, unknown);
    }

    int SetDeleteCB(void(*callback)(PhWidget*, PhEvent*, void*), void* unknown)
    {
        return paf_818162F2(this, callback, unknown);
    }
    ...
    // vtable
    bool IsInherit(char const* type){ return VirtualMethod<bool>(0, type); }
    char const* WidgetType(){ return VirtualMethod<char const*>(1); }
    void Destructor1(){ VirtualMethod(2); }
    void Destructor2(){ VirtualMethod(3); }
    void DestroyWidget(){ VirtualMethod(4); }
    int GetHandlerState(){ return VirtualMethod(5); }
    int EventExec(PhEvent* pEvent){ return VirtualMethod(6, pEvent); }
    int HandlerProc(PhEvent* pEvent){ return VirtualMethod(7, pEvent); }
    int HandleKeycodeEvent(PhEvent* pEvent){ return VirtualMethod(8, pEvent); }
    int HandleAnalogEvent(PhEvent* pEvent){ return VirtualMethod(9, pEvent); }
    int HandlePointEvent(PhEvent* pEvent){ return VirtualMethod(10, pEvent); }
    int HandleFocusEvent(PhEvent* pEvent){ return VirtualMethod(11, pEvent); }
    int HandleFocusSwitchEvent(PhEvent* pEvent){ return VirtualMethod(12, pEvent); }
    int HandleFocusOutEvent(PhEvent* pEvent){ return VirtualMethod(13, pEvent); }
    int HandleFocusInEvent(PhEvent* pEvent){ return VirtualMethod(14, pEvent); }
    int HandleStateEvent(PhEvent* pEvent){ return VirtualMethod(15, pEvent); }
    int HandleCommandEvent(PhEvent* pEvent){ return VirtualMethod(16, pEvent); }
    int HandleSystemEvent(PhEvent* pEvent){ return VirtualMethod(17, pEvent); }
...
public:
    ...
    int dword_0x20;
    int handlerId;
    int handlerState; // set to 2 by DestroyWidget()
    int dword_0x2C;
    char byte_0x30;
    int dword_0x34;
    int dword_0x38;
    int dword_0x3C;
    int dword_0x40;
    std::vector<void*> HandlerCBData; // used if id & 0x10000
    std::vector<void*> HandlerCBData_0; // if id & 0x20000
    std::vector<void*> HandlerCBData_1; // if id & 0x40000
    std::vector<void*> HandlerCBData_2; // if id & 0x80000
    std::vector<void*> HandlerCBData_3; // used by default
    std::vector<void*> HandlerCBData_4; // if id & 0x108000
    int dword_0xA4;
    int dword_0xA8;
    int dword_0xAC;
    int dword_0xB0;
...
// Used to register/remove widgets, get widgets count etc...
class PhDispatcher : public PhHandler
{
public:
    PhWidget* GetDispatcher(){ return VirtualMethod<PhWidget*>(18); }

public:
    int dword_0xB4;
    std::vector<PhWidget*> childs;
    int dword_0xC8;
    int dword_0xCC;
};
...
public:
    ...
    PhWidget& SetScale(float scale)
    {
        scaleOnTimer = { scale, scale, 0.0, 0.0 };
        KillTimerCB(ScaleHandler);
        return *this;
    }
    ...
    bool IsAttached()
    {
        if (!name.empty() && parent)
            return parent->FindChild(name.c_str(), 0) != nullptr;
    ...
    // vtable
    bool RemoveChild(int childIndex){ return VirtualMethod<bool>(19, childIndex); }
    bool RemoveChild(PhWidget const* child){ return VirtualMethod<bool>(20, child); }
    void RegistChild(PhWidget* child){ VirtualMethod(21, child); }

    bool SetLayoutPos(int layoutFactorX, int layoutFactorY, int layoutFactorZ, vec4 layoutPos){ return VirtualMethod<bool>(22, layoutFactorX, layoutFactorY, layoutFactorZ, layoutPos); }
    bool SetLayoutSize(int layoutFactorX, int layoutFactorY, int layoutFactorZ, vec4 layoutSize){ return VirtualMethod<bool>(23, layoutFactorX, layoutFactorY, layoutFactorZ, layoutSize); }
    void GetLayoutPos(int& layoutFactorX, int& layoutFactorY, int& layoutFactorZ, vec4& layoutPos){ VirtualMethod(24, &layoutFactorX, &layoutFactorY, &layoutFactorZ, &layoutPos); }
    void GetLayoutSize(int& layoutFactorX, int& layoutFactorY, int& layoutFactorZ, vec4& layoutSize){ VirtualMethod(25, &layoutFactorX, &layoutFactorY, &layoutFactorZ, &layoutSize); }
    bool UpdateLayoutPos(){ return VirtualMethod<bool>(26); }
    bool UpdateLayoutSize(){ return VirtualMethod<bool>(27); }
    bool UpdateLayoutStyle(int style){ return VirtualMethod<bool>(28, style); }
    void UpdateLayout(bool updateChilds){ VirtualMethod(29, updateChilds); }
    ...
    void SetSize_ontimer(vec4 const& size){ VirtualMethod(36, &size); }
    int UpdateState(){ return VirtualMethod(37); }
    void DrawThis(unsigned int r4, bool r5){ VirtualMethod(38, r4, r5); }
    int SetShowState(int showState){ return VirtualMethod(39, showState); }
    int paf_6458160F(int r4, int r5, int r6, int r7){ return VirtualMethod(40, r4, r5, r6, r7); }

    int SetStyle(int style, bool value){ return VirtualMethod(41, style, value); }
    int SetStyle(int style, int value){ return VirtualMethod(42, style, value); }
    int SetStyle(int style, float value){ return VirtualMethod(43, style, value); }
    int SetStyle(int style, vec4 const& value){ return VirtualMethod(44, style, &value); }
    int SetStyle(int style, int r5, bool value){ return VirtualMethod(45, style, r5, value); }
    int SetStyle(int style, int r5, int value){ return VirtualMethod(46, style, r5, value); }
    int SetStyle(int style, int r5, float value){ return VirtualMethod(47, style, r5, value); }
    int SetStyle(int style, int r5, vec4 const& value){ return VirtualMethod(48, style, r5, &value); }
    int GetStyle(int style, bool& value){ return VirtualMethod(49, style, &value); }
    int GetStyle(int style, int& value){ return VirtualMethod(50, style, &value); }
    int GetStyle(int style, float& value){ return VirtualMethod(51, style, &value); }
    int GetStyle(int style, vec4& value){ return VirtualMethod(52, style, &value); }
    int GetStyle(int style, mat4& matrix){ return VirtualMethod(53, style, &matrix); }
    int GetStyle(int style, int r5, bool& value){ return VirtualMethod(54, style, r5, &value); }
    int GetStyle(int style, int r5, int& value){ return VirtualMethod(55, style, r5, &value); }
    int GetStyle(int style, int r5, float& value){ return VirtualMethod(56, style, r5, &value); }
    int GetStyle(int style, int r5, vec4& value){ return VirtualMethod(57, style, r5, &value); }
    int GetStyle(int style, int r5, mat4& matrix){ return VirtualMethod(58, style, r5, &matrix); }

    int SetLayoutStyle(int style, int r5, float value){ return VirtualMethod(59, style, r5, value); }
    int SetLayoutStyle(int style, int r5, int r6, int r7, vec4 value){ return VirtualMethod(60, style, r5, r6, r7, value); }
    int SetLayoutStyle(int style, int r5, int r6, float value){ return VirtualMethod(61, style, r5, r6, value); }
    int SetLayoutStyle(int style, int r5, int r6, int r7, int r8, vec4 value){ return VirtualMethod(62, style, r5, r6, r7, r8, value); }
    int GetLayoutStyle(int style, int& r5, float& value){ return VirtualMethod(63, style, &r5, &value); }
    int GetLayoutStyle(int style, int& r5, int& r6, int& r7, vec4& value){ return VirtualMethod(64, style, &r5, &r6, &r7, &value); }
    int GetLayoutStyle(int style, int r5, int& r6, float& value){ return VirtualMethod(65, style, r5, &r6, &value); }
    int GetLayoutStyle(int style, int r5, int& r6, int& r7, int& r8, vec4& value){ return VirtualMethod(66, style, r5, &r6, &r7, &r8, &value); }

    int paf_ADE746B6(int r4, int r5){ return VirtualMethod(67, r4, r5); }
    int SetTexture(SurfacePtr const& texture, int r5){ return VirtualMethod(68, &texture, r5); }
    int GetTexture(SurfacePtr& texture, int r5){ return VirtualMethod(69, &texture, r5); }

    int SetText(std::wstring const& text, int r5){ return VirtualMethod(70, &text, r5); }
    int GetText(std::wstring& text, int r5){ return VirtualMethod(71, &text, r5); }
    int BeginEditText(PhEditText::OskParam& oskParam, int r5){ return VirtualMethod(72, &oskParam, r5); }
    int EndEditText(){ return VirtualMethod(73); }
    int GetEditTextPart(int& part){ return VirtualMethod(74, &part); }

    void paf_12CACB14(){ VirtualMethod(75); }
    int SetFocus(PhEvent* pEvent, unsigned int r5){ return VirtualMethod(76, pEvent, r5); }
    int ReleaseFocus(bool r4){ return VirtualMethod(77, r4); }
    int SetDispatch(unsigned int r4){ return VirtualMethod(78, r4); }
    int SetAnim(int r4, int r5, int r6, int r7, float f1, float f2){ return VirtualMethod(79, r4, r5, r6, r7, f1, f2); }
    int SetLayoutAnim(int r4, int r5, int r6, int r7, int r8, float f1, int r10, float f2){ return VirtualMethod(80, r4, r5, r6, r7, r8, f1, r10, f2); }

public:
    // start 0xD0
    void*(**mallocCB)(size_t); // inherited from parent/dispatcher
    void(**freeCB)(void*);
    PhWidget* parent;
    void* scene; // PhScene*
    PhWidget* dispatcher;
    ...
    float float_0x108;
    float metaAlpha;
    float defocusForeground;
    float defocusBackground;
    char __padding_0x118[0x8];
    vec4 colorScale;
    vec4 positionOnTimer;
    vec4 scaleOnTimer;
    quat rotationOnTimer;
    quat quat_0x160;
    mat4 mat4_0x170;
    mat4 mat4_0x1B0;
    mat4 mat4_0x1F0;
...
{
public:
    PhPlane(PhWidget* parent, PhAppear* appear)
    {
...
public:
    ...
    {
        PhSText* textHandle;
        appear->GetSText(&textHandle);

        textHandle->RefreshText();
        return *this;
    }
    ...
    PhText& SetTextHeight(float height)
    {
        ...
        textHandle->SetStyle(PhSText::LineHeight, height);
        return *this;
    }
    ...
    float GetTextHeight()
    {
        ...
        float height = 0.0;
        textHandle->GetStyle(PhSText::LineHeight, height);
        return height;
    }
